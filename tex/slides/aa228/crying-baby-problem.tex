...
\begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.45\columnwidth}
        \begin{itemize}
            ...
            \begin{itemize}
                \item \href{http://htmlview.glitch.me/?https://raw.githubusercontent.com/sisl/StateEstimation.jl/master/html/crying_baby_problem.html}{\color{cardinal}crying\_baby\_problem.jl}
            \end{itemize}
        \end{itemize}
    \end{column}
\end{columns}
