\begin{frame}[fragile]{What is this tutorial?}
    ...
    \begin{column}{0.35\linewidth}
        \begin{figure}
            ...
            \begin{tikzpicture}
                ...
                \node[minimum size=1cm, draw=pastelBlue, fill=pastelBlue!40, circle, below=0.25cm of s] (o) {$o_t$};
                \node[minimum size=1.3cm, draw=black, fill=white, diamond, above=0.25cm of s] (r) {$r_t$};
                \node[minimum size=1cm, draw=black, fill=white, rectangle, above=0.25cm of r] (a) {$a_t$};
                \node[minimum size=1cm, draw=black, fill=white, rectangle, left=1cm of a] (am1) {$a_{t-1}$};
                \node[minimum size=1.3cm, draw=lightgray, fill=lightgray!40, diamond] (rm1) at (am1|-r) {\textcolor{gray}{$r_{t-1}$}};
                \node[minimum size=1cm,   draw=lightgray, fill=lightgray!40, circle]  (sm1) at (am1|-s) {\textcolor{gray}{$s_{t-1}$}};
                \node[minimum size=1cm,   draw=lightgray, fill=lightgray!40, circle]  (om1) at (am1|-o) {\textcolor{gray}{$o_{t-1}$}};
                \node[minimum size=1cm,   draw=lightgray, fill=lightgray!40, rectangle] (ap1) at (s2|-a) {\textcolor{gray}{$a_{t+1}$}};
                \node[minimum size=1.3cm, draw=lightgray, fill=lightgray!40, diamond]   (rp1) at (s2|-r) {\textcolor{gray}{$r_{t+1}$}};
                \node[minimum size=1cm,   draw=lightgray, fill=lightgray!40, circle]    (op1) at (s2|-o) {\textcolor{gray}{$o_{t+1}$}};
                \draw[->] (s) -- (o);
                \draw[->] (s) -- (s2);
                \draw[->] (s) -- (r);
                \draw[->] (a) -- (r);
...
\begin{tikzpicture}[remember picture, overlay]
    \node[xshift=-2.8cm, yshift=2.3cm] (img1) at (current page.south east) {\includegraphics[height=3cm]{images/pomdps_logo.pdf}};
...
\begin{tikzpicture}[remember picture, overlay]
    \node[xshift=-2.0cm, yshift=2cm] (img1) at (current page.south east) {\includegraphics[height=2cm]{images/pomdps_logo.pdf}};
    % \node[xshift=-2cm, yshift=2cm] (img1) at (current page.south east) {\transduration<0-21>{0}\multiinclude[<+->][format=png, graphics={width=\textwidth}]{images/grid-world-animation/gridworld_value_iteration_γ}};
\end{tikzpicture}
